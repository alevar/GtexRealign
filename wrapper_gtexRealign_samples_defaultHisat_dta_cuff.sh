...
#
    ...
    hisat2 -1 ./outBladder/tmpData/${sample}_r1.fq,./outBladder/tmpData/${sample}_s1.fq -2 ./outBladder/tmpData/${sample}_r2.fq,./outBladder/tmpData/${sample}_s2.fq --dta-cufflinks -x ${genomeIDX} -p ${threads} -S ${outputDir}/${sample}.sam
